<footer class="footer padding-t-100 bg-off-white">
        <div class="container">
                ...
                <div class="col-xl-2 col-lg-3 col-sm-12 col-12 cr-footer-border">
                    <div class="cr-footer">
                        ...
                        <ul class="cr-footer-links cr-footer-dropdown">
                            ...
                            <li><a href="faq.php">Support Center</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-3 col-sm-12 col-12 cr-footer-border">
                    <div class="cr-footer">
                        ...
                        <ul class="cr-footer-links cr-footer-dropdown">
                            <li><a href="shop-left-sidebar.php">Dairy & Bakery</a></li>
                            <li><a href="shop-left-sidebar.php">Fruits & Vegetable</a></li>
                            <li><a href="shop-left-sidebar.php">Snack & Spice</a></li>
                            <li><a href="shop-left-sidebar.php">Juice & Drinks</a></li>
                            <li><a href="shop-left-sidebar.php">Chicken & Meat</a></li>
                            <li><a href="shop-left-sidebar.php">Fast Food</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="cr-last-footer">
                <p>&copy; <span id="copyright_year"></span> <a href="index.php">Carrot</a>, All rights reserved.</p>
            </div>
        </div>
    </footer>
