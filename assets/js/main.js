(function ($) {
    ...
    $('.wishlist').on("click", function () {
        ...
        if (isWishlist) {
            ...
            $('footer').after('<div class="cr-wish-notify"><p class="wish-note">Remove product on <a href="wishlist.php"> Wishlist</a> Successfully!</p></div>');
        } else {
            $(this).addClass("active");
            $('footer').after('<div class="cr-wish-notify"><p class="wish-note">Add product in <a href="wishlist.php"> Wishlist</a> Successfully!</p></div>');
        }
...
$(document).ready(function() {
    ...
    $('#categoryFilter').change(function() {
        let cat_id = $(this).val();
        $.get("?cat_id=" + cat_id, function(data) {
            let newPage = $(data).find('#products').html();
            let newProductCount = $(data).find('#productCountMessage').html(); // Updated message
            $('#products').html(newPage);
            $('#productCountMessage').html(newProductCount); // Update message dynamically
        });
    });

    // Handle Add to Cart AJAX submission using event delegation
